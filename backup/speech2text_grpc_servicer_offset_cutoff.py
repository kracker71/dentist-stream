...
NUM_PREV_RESULT = 5
MAX_LENGTH_AUDIO_BUFF = 96000 * 10
RESET_CUTOFF_NUM = 5
...
class GowajeeSpeechRecognizerService(GowajeeSpeechToTextServicer):
    ...
    def StreamingTranscribe(
        ...
        #### Add-on
        long_audio_buffer = b""
        cutoff_transcript = [""] * NUM_PREV_RESULT ## contain a previous transcript for cutting the audio
        ...
        for request in request_iterator:
            ...
            if cutoff:
                ...
                if len(results) > 1:
                    ...
                    prev_results = results[:-1] # the previous version, we add the result to the prev_results
